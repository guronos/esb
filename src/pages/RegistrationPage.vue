<template>
    ...
    >
        ...
        <el-form-item label="Согласен на предоставление Cookie" prop="isAcceptedCookies">
            <el-checkbox v-model="userCreate.isAcceptedCookies" name="isAcceptedCookies">
            </el-checkbox>
        </el-form-item>
        <el-form-item label="Согласен с условиями лицензии" prop="isAcceptLicense">
            <el-checkbox v-model="userCreate.isAcceptLicense" name="isAcceptLicense">
            </el-checkbox>
        </el-form-item>
        <el-form-item>
            <el-button type="primary" @click="submitForm(userCreateRef)">
                Зарегистрироваться
            </el-button>
...
const rules = reactive<FormRules<I_UserCreate>>({
  ...
  birthDate: [
    { required: false, message: 'Заполните дату рождения', trigger: 'blur' },
  ],
  sex: [
    { required: false, message: 'Please input Activity name', trigger: 'blur' },
  ],
